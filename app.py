...
def edit_recipe(recipe_id):
    ...
    if edit_recipe:
        return render_template('edit-recipe.html', recipe=edit_recipe, all_roles=roles.find())
...
def add_category():
    ...
    return render_template('categories-admin.html', all_roles=roles.find(), all_users=users.find())
